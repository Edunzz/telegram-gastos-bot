...
GOOGLE_SHEET_URL = os.getenv("GOOGLE_SHEET_URL", "https://docs.google.com/")
...
def crear_boton_reporte():
    return {
        "inline_keyboard": [[
            {"text": "📊 Ver reporte en Google Sheets", "url": GOOGLE_SHEET_URL}
        ]]
    }
...
async def telegram_webhook(req: Request):
    try:
        ...
        httpx.post(f"{BASE_URL}/sendMessage", json={
            ...
            "text": msg,
            "parse_mode": "Markdown",
            "reply_markup": crear_boton_reporte()
        })
        return {"ok": True}
